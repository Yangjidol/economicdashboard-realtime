...
export const seriesList = [
  ...
  { id: 'kr2y', label: '한국 2년', category: '국채수익률', source: 'ecos-keystat', match: '국고채수익률(2년)', unit: '%' },
  { id: 'kr3y', label: '한국 3년', category: '국채수익률', source: 'ecos-keystat', match: '국고채수익률(3년)', unit: '%' },
  { id: 'kr5y', label: '한국 5년', category: '국채수익률', source: 'ecos-keystat', match: '국고채수익률(5년)', unit: '%' },
  { id: 'kr10y', label: '한국 10년', category: '국채수익률', source: 'ecos-keystat', match: '국고채수익률(10년)', unit: '%' },
  { id: 'kr30y', label: '한국 30년', category: '국채수익률', source: 'ecos-keystat', match: '국고채수익률(30년)', unit: '%' },
